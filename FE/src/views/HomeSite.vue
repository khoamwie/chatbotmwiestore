...
export default {
  data() {
    return {
      brands: null,
      products: [
        {name: 'Sữa Tăng Cơ Applied Nutrition ISO-XP 1.8kg - 72 Lần Dùng', images: 'product_2', price: '1,785,000 '},
        {name: 'Viên Uống Đốt Mỡ Nutrex Lipo-6 Black Stim-Free 60 Viên', images: 'product_1', price: '800,000 '},
