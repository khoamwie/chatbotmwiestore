...
var _hoisted_2 = { class: "p-confirm-popup-message" };
var _hoisted_3 = { class: "p-confirm-popup-footer" };
      ...
      createVNode(Transition, {
        ...
        default: withCtx(() => [
          $data.visible ? (openBlock(), createElementBlock("div", mergeProps({
            ...
            !_ctx.$slots.message ? (openBlock(), createElementBlock("div", _hoisted_1, [
              createBaseVNode("i", {
                class: normalizeClass($options.iconClass)
              }, null, 2),
              createBaseVNode("span", _hoisted_2, toDisplayString($data.confirmation.message), 1)
...
// dep:primevue_confirmpopup
var primevue_confirmpopup_default = script3;
export {
  primevue_confirmpopup_default as default
};
