...
var _hoisted_6 = createBaseVNode("span", { class: "p-listbox-filter-icon pi pi-search" }, null, -1);
var _hoisted_7 = {
  role: "status",
  "aria-live": "polite",
  class: "p-hidden-accessible"
};
var _hoisted_8 = ["id", "aria-multiselectable", "aria-label", "aria-labelledby", "aria-activedescendant", "aria-disabled"];
var _hoisted_9 = ["id"];
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("div", {
    ...
    $props.filter ? (openBlock(), createElementBlock("div", _hoisted_3, [
      ...
      createBaseVNode("span", _hoisted_7, toDisplayString($options.filterResultMessageText), 1)
      ...
      createVNode(_component_VirtualScroller, mergeProps({ ref: $options.virtualScrollerRef }, $props.virtualScrollerOptions, {
        ...
        content: withCtx(({ styleClass, contentRef, items, getItemOptions, contentStyle, itemSize }) => [
          createBaseVNode("ul", {
            ...
            $data.filterValue && (!items || items && items.length === 0) ? (openBlock(), createElementBlock("li", _hoisted_11, [
              renderSlot(_ctx.$slots, "emptyfilter", {}, () => [
                createTextVNode(toDisplayString($options.emptyFilterMessageText), 1)
              ])
            ])) : !$props.options || $props.options && $props.options.length === 0 ? (openBlock(), createElementBlock("li", _hoisted_12, [
              renderSlot(_ctx.$slots, "empty", {}, () => [
                createTextVNode(toDisplayString($options.emptyMessageText), 1)
              ])
            ])) : createCommentVNode("", true)
          ], 46, _hoisted_8),
          !$props.options || $props.options && $props.options.length === 0 ? (openBlock(), createElementBlock("span", _hoisted_13, toDisplayString($options.emptyMessageText), 1)) : createCommentVNode("", true),
          createBaseVNode("span", _hoisted_14, toDisplayString($options.selectedMessageText), 1)
        ]),
        _: 2
      }, [
        _ctx.$slots.loader ? {
...
// dep:primevue_listbox
var primevue_listbox_default = script2;
export {
  primevue_listbox_default as default
};
