...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("div", {
    ...
    !$data.d_active ? (openBlock(), createElementBlock("div", {
      key: 0,
    ...
    ], 42, _hoisted_1)) : (openBlock(), createElementBlock("div", _hoisted_2, [
      renderSlot(_ctx.$slots, "content"),
      $props.closable ? (openBlock(), createBlock(_component_IPButton, {
        key: 0,
        icon: "pi pi-times",
...
// dep:primevue_inplace
var primevue_inplace_default = script2;
export {
  primevue_inplace_default as default
};
