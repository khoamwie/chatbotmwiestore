...
var _hoisted_12 = createBaseVNode("span", { class: "p-multiselect-filter-icon pi pi-search" }, null, -1);
var _hoisted_13 = {
  key: 2,
  role: "status",
  "aria-live": "polite",
...
var _hoisted_15 = createBaseVNode("span", { class: "p-multiselect-close-icon pi pi-times" }, null, -1);
var _hoisted_16 = [
  _hoisted_15
];
var _hoisted_17 = ["id"];
var _hoisted_18 = ["id"];
var _hoisted_19 = ["id", "aria-label", "aria-selected", "aria-disabled", "aria-setsize", "aria-posinset", "onClick", "onMousemove"];
var _hoisted_20 = { class: "p-checkbox p-component" };
var _hoisted_21 = {
  key: 0,
          ...
          default: withCtx(() => [
            $data.overlayVisible ? (openBlock(), createElementBlock("div", mergeProps({
              ...
              $props.showToggleAll && $props.selectionLimit == null || $props.filter ? (openBlock(), createElementBlock("div", _hoisted_7, [
                ...
                $props.filter ? (openBlock(), createElementBlock("span", _hoisted_13, toDisplayString($options.filterResultMessageText), 1)) : createCommentVNode("", true),
                    ...
                    createBaseVNode("ul", {
                      ...
                      (openBlock(true), createElementBlock(Fragment, null, renderList(items, (option, i) => {
                        return openBlock(), createElementBlock(Fragment, {
                          ...
                          ], 12, _hoisted_18)) : withDirectives((openBlock(), createElementBlock("li", {
                            key: 1,
                            id: $options.id + "_" + $options.getOptionIndex(i, getItemOptions),
                            style: normalizeStyle({ height: itemSize ? itemSize + "px" : void 0 }),
                      ...
                      $data.filterValue && (!items || items && items.length === 0) ? (openBlock(), createElementBlock("li", _hoisted_21, [
                        renderSlot(_ctx.$slots, "emptyfilter", {}, () => [
                          createTextVNode(toDisplayString($options.emptyFilterMessageText), 1)
                        ])
                      ])) : !$props.options || $props.options && $props.options.length === 0 ? (openBlock(), createElementBlock("li", _hoisted_22, [
                        renderSlot(_ctx.$slots, "empty", {}, () => [
                          createTextVNode(toDisplayString($options.emptyMessageText), 1)
                        ])
                      ])) : createCommentVNode("", true)
                    ], 14, _hoisted_17),
                    !$props.options || $props.options && $props.options.length === 0 ? (openBlock(), createElementBlock("span", _hoisted_23, toDisplayString($options.emptyMessageText), 1)) : createCommentVNode("", true),
                    createBaseVNode("span", _hoisted_24, toDisplayString($options.selectedMessageText), 1)
                  ]),
                  _: 2
                }, [
                  _ctx.$slots.loader ? {
...
var primevue_multiselect_default = script3;
export {
