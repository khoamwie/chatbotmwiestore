...
var _hoisted_2 = ["href", "onClick", "onKeydown"];
var _hoisted_3 = { class: "p-menuitem-text" };
var _hoisted_4 = ["href", "target", "aria-haspopup", "aria-expanded", "onClick", "onKeydown", "tabindex"];
        ...
        $options.visible(item) && !item.separator ? (openBlock(), createElementBlock("li", {
          ...
          !$props.template ? (openBlock(), createElementBlock(Fragment, { key: 0 }, [
            item.to && !$options.disabled(item) ? (openBlock(), createBlock(_component_router_link, {
              ...
              item.items ? (openBlock(), createElementBlock("span", _hoisted_6)) : createCommentVNode("", true)
            ], 42, _hoisted_4)), [
              [_directive_ripple]
            ])
          ...
          $options.visible(item) && item.items ? (openBlock(), createBlock(_component_TieredMenuSub, {
            ...
            exact: $props.exact
          }, null, 8, ["model", "template", "onLeafClick", "onKeydownItem", "parentActive", "exact"])) : createCommentVNode("", true)
  ...
  return openBlock(), createBlock(_component_Portal, {
    ...
    default: withCtx(() => [
      createVNode(Transition, {
        ...
        default: withCtx(() => [
          ($props.popup ? $data.visible : true) ? (openBlock(), createElementBlock("div", mergeProps({
            key: 0,
...
//# sourceMappingURL=chunk-G7ZBJQ5A.js.map
