...
var _hoisted_4 = ["href", "target", "onClick", "aria-haspopup", "aria-expanded", "tabindex"];
...
function render$1(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createBlock(Transition, {
    ...
    default: withCtx(() => [
      ($props.root ? true : $props.parentActive) ? (openBlock(), createElementBlock("ul", {
        key: 0,
        ref: "container",
        ...
        (openBlock(true), createElementBlock(Fragment, null, renderList($props.model, (item, i) => {
          return openBlock(), createElementBlock(Fragment, {
            ...
            $options.visible(item) && !item.separator ? (openBlock(), createElementBlock("li", {
              ...
              $options.visible(item) && item.items ? (openBlock(), createBlock(_component_ContextMenuSub, {
                ...
                exact: $props.exact
              }, null, 8, ["model", "template", "onLeafClick", "parentActive", "exact"])) : createCommentVNode("", true)
...
// dep:primevue_contextmenu
var primevue_contextmenu_default = script2;
export {
  primevue_contextmenu_default as default
};
