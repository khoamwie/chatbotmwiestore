...
var _hoisted_2$1 = ["id", "aria-label", "aria-selected", "aria-expanded", "aria-setsize", "aria-posinset", "aria-level"];
    ...
    (openBlock(true), createElementBlock(Fragment, null, renderList($props.options, (processedOption, index) => {
      return openBlock(), createElementBlock("li", {
        ...
        withDirectives((openBlock(), createElementBlock("div", {
          ...
          $options.isOptionGroup(processedOption) ? (openBlock(), createElementBlock("span", _hoisted_5$1)) : createCommentVNode("", true)
        ], 8, _hoisted_3$1)), [
          [_directive_ripple]
        ]),
        ...
        }, null, 8, ["selectId", "focusedOptionId", "options", "activeOptionPath", "level", "templates", "optionLabel", "optionValue", "optionDisabled", "optionGroupLabel", "optionGroupChildren", "onOptionChange"])) : createCommentVNode("", true)
      ], 10, _hoisted_2$1);
    }), 128))
  ]);
}
...
var primevue_cascadeselect_default = script2;
export {
