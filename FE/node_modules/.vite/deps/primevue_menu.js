...
var _hoisted_1$1 = ["href", "onClick"];
var _hoisted_2$1 = { class: "p-menuitem-text" };
var _hoisted_3 = ["href", "target", "tabindex"];
...
function render$1(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return $options.visible() ? (openBlock(), createElementBlock("li", {
    ...
    !$props.template ? (openBlock(), createElementBlock(Fragment, { key: 0 }, [
      $props.item.to && !$options.disabled($props.item) ? (openBlock(), createBlock(_component_router_link, {
        key: 0,
        to: $props.item.to,
        custom: ""
      }, {
        default: withCtx(({ navigate, href, isActive, isExactActive }) => [
          withDirectives((openBlock(), createElementBlock("a", {
            ...
            createBaseVNode("span", _hoisted_2$1, toDisplayString($options.label()), 1)
          ], 10, _hoisted_1$1)), [
            [_directive_ripple]
          ])
        ]),
        ...
        createBaseVNode("span", _hoisted_4, toDisplayString($options.label()), 1)
      ], 10, _hoisted_3)), [
        [_directive_ripple]
      ])
              ...
              (openBlock(true), createElementBlock(Fragment, null, renderList($props.model, (item, i) => {
                return openBlock(), createElementBlock(Fragment, {
                  ...
                  item.items && $options.visible(item) && !item.separator ? (openBlock(), createElementBlock(Fragment, { key: 0 }, [
                    item.items ? (openBlock(), createElementBlock("li", _hoisted_2, [
                    ...
                    (openBlock(true), createElementBlock(Fragment, null, renderList(item.items, (child, j) => {
                      return openBlock(), createElementBlock(Fragment, {
                        ...
                        $options.visible(child) && !child.separator ? (openBlock(), createBlock(_component_Menuitem, {
                          key: 0,
                          item: child,
                          onClick: $options.itemClick,
                          template: _ctx.$slots.item,
                          exact: $props.exact
                        }, null, 8, ["item", "onClick", "template", "exact"])) : $options.visible(child) && child.separator ? (openBlock(), createElementBlock("li", {
                          key: "separator" + i + j,
                    ...
                    role: "separator"
                  }, null, 6)) : (openBlock(), createBlock(_component_Menuitem, {
                    key: $options.label(item) + i.toString(),
                    item,
                    onClick: $options.itemClick,
                    template: _ctx.$slots.item,
...
// dep:primevue_menu
var primevue_menu_default = script2;
export {
