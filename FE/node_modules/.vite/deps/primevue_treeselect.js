        ...
        case "ArrowDown":
          if (this.overlayVisible) {
            if (DomHandler.findSingle(this.overlay, ".p-highlight")) {
              ...
              DomHandler.findSingle(this.overlay, ".p-treenode").children[0].focus();
          } else {
            this.show();
          }
...
// dep:primevue_treeselect
var primevue_treeselect_default = script3;
export {
  primevue_treeselect_default as default
};
